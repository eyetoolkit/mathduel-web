...
(function () {
  ...
  var HIDE_BY_SLUG = {
    '24-game':          ['#clear', '#pause', '#show-answer', '#skip', '#rush-btn', '#history-btn', '#share-btn', '#sound-btn', '#undo', '#paren-open', '#paren-close', '#battle-btn', '#daily-btn'],
    'sudoku':           ['#pause', '#auto-check-btn', '#theme-btn', '#coins-bar-btn', '#daily-btn', '#battle-btn'],
  ...
  var CSS = [
    ...
    '.gc-cols{display:grid;grid-template-columns:minmax(0,1fr) 300px;gap:24px;align-items:start}',
    ...
    '.gc-on .g24-pad [data-type="paren"],.gc-on .g24e-pad [data-type="paren"]{display:none!important}',
    /* killer 难度条 */
    ...
    '.gc-on .g24e-pad{display:flex!important;justify-content:center;align-items:center;flex-wrap:wrap;gap:10px;max-width:none!important}',
    '.gc-on .g24e-pad button.op,.gc-on .g24-pad button.op{background:#fff!important;color:#1d1d1f!important;border:1px solid #e0e0e0!important;box-shadow:none!important;width:48px;height:44px;font-size:19px}',
    '.gc-on .g24e-pad button.op:hover,.gc-on .g24-pad button.op:hover{border-color:#0066CC!important;color:#0066CC!important}',
    ...
    '.gc-boardcard{background:#f5f5f7;border-radius:18px;padding:20px!important;margin-top:4px}',
  ...
  function build() {
    ...
    if (banner) {
      ...
      if (dEl && !dEl.textContent) dEl.textContent = ' #' + todayKeyUTC();
